...
public class JpegModel extends EntityModel<MobEntity> {

    private final ModelPart base;

    public JpegModel(ModelPart modelPart) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild(EntityModelPartNames.CUBE, ModelPartBuilder.create().uv(0, 0)
                .cuboid(-34.5f, -45f, 0f, 69f, 69f, 0.5f),
                ModelTransform.pivot(0f, 0f, 0f)
        );
        return TexturedModelData.of(modelData, 69, 69);
    }
